      ...
      <div className="max-w-6xl mx-auto px-6 pt-20 pb-8 md:pb-12 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 md:gap-10">
        ...
        <div className="col-span-1 sm:col-span-2 md:col-span-1">
          ...
          <div className="flex flex-col gap-2">
            ...
            <a href="/admin" className="font-sans text-xs text-cream/30 hover:text-white transition-colors">
              {t("관리자 페이지", "Admin")}
            </a>
          </div>
        </div>
      ...
      <div className="border-t border-cream/8 px-6 py-8">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <a href="/admin" className="font-sans text-cream/15 text-[10px] hover:text-cream/40 transition-colors">
              관리자
            </a>
          </div>
        </div>
